...
@section('content')
    ...
    <div class="container" style="margin-top: 90px">
        <h2>List Event</h2>
        <table class="table table-bordered table-striped table-responsive-stack" id="example">
                ...
                <tr>
                    <td>{{ $event->name_event }}
                            ...
                            <div style="text-align: right">
                                <a  href="/club/events/{{$event->id}}/1/live-result" title="Hasil Lomba" id="red-buton" class="btn btn-secondary"><i class="fa fa-list-ol" aria-hidden="true"></i></a>
                            </div>
