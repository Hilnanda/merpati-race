            ...
            <div class="box-body">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td class="action-link d-flex flex-row-reverse">
                        <a href="#" title="Results"><i class="fa fa-list-alt" aria-hidden="true"></i></a>
                        <a href="#" title="Live Results" class="mx-2"><i class="fa fa-list-ol" aria-hidden="true"></i></a>
                        <a href="#" title="Basketed List"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                    </td>
                  </tr>
                  @endforeach
              </tbody>
